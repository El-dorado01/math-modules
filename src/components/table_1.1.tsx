...
const Table1_Data: Table1_DataProps[] = [
  {
    no_of_balls: 8,
...
const Table1 = () => {
  return (
    <Table className="max-w-[600px] w-full">
      <TableCaption>Table 1.1</TableCaption>
      <TableHeader>
        <TableRow className="bg-sidebar-accent">
          <TableHead className="w-[150px] sticky left-0 bg-sidebar">
            No. of balls
          </TableHead>
          <TableHead>
            3 <br /> <b>Base 3</b>
      ...
      <TableBody>
        {Table1_Data.map((data) => (
          <TableRow key={data.no_of_balls}>
